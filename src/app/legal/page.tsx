      ...
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '2rem 1.6rem 4rem' }}>
        ...
        {tab === 'promise' && (
          <article className="fade-in">
            ...
            <p className="serif" style={{ fontSize: '1.3rem', fontStyle: 'italic', marginTop: '2rem', color: 'var(--ink)' }}>— The Grouw team</p>
          </article>
        )}
        ...
        {tab === 'terms' && (
          <article className="fade-in">
            ...
            {[['Who can join','Anyone 16 or older, willing to show up honestly.'],
              ...
              ['What is never allowed','Harassment, hate, spam, self-promotion, or treating Grouw like a marketing channel.'],
              ["Grouw's rights",'We can remove content that breaks these rules and close accounts that harm others.'],
