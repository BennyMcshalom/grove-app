...
export function MessageBubble({ msg, myId, bondId, otherName, otherAvatarUrl, onReply }: {
  ...
  if (msg.kind === 'call_missed_voice' || msg.kind === 'call_missed_video') {
    return (
      <div style={{ display: 'flex', justifyContent: 'center', margin: '.85rem 0' }}>
        <div style={{
          display: 'flex', alignItems: 'center', gap: '.45rem', padding: '.4rem .95rem',
  ...
  return (
    <>
      <div
        style={{
          display: 'flex', justifyContent: sent ? 'flex-end' : 'flex-start',
      ...
      >
        ...
        <div style={{ position: 'relative', maxWidth: '68%' }}>
          ...
          {msg.replyPreview && (
            <div style={{
              ...
              <div style={{ padding: '.38rem .65rem', minWidth: 0, flex: 1 }}>
                <div style={{
                  fontSize: '.7rem', fontWeight: 700, marginBottom: '.1rem',
                ...
                <div style={{
                  fontSize: '.76rem', lineHeight: 1.35,
          ...
          {msg.kind === 'shared_post' && msg.sharedPostId ? (
            ...
            <div style={{
              padding: '.68rem 1rem', borderRadius: 20, fontSize: '.92rem', lineHeight: 1.55,
          ...
          {reactionList.length > 0 && (
            <div style={{
              ...
              marginTop: 6, justifyContent: sent ? 'flex-end' : 'flex-start'
            }}>
