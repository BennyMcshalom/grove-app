...
export function PayStep({ plan, card, setCard, cardReady, onBackToPlan, onStartTrial }: {
  plan: Plan;
    ...
    <div className="screen-enter">
      ...
      <div className="card" style={{ padding: '1.1rem 1.4rem', marginBottom: '1.2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        ...
        <div style={{ textAlign: 'right' }}>
          ...
          <button onClick={onBackToPlan} style={{ fontSize: '.72rem', color: 'var(--ember)' }}>Change</button>
        </div>
      </div>
      ...
      <button className="btn btn-primary btn-lg btn-block" disabled={!cardReady} onClick={onStartTrial}
