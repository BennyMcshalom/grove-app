...
export function PlanStep({ plan, setPlan, onStartTrial }: {
  plan: Plan; setPlan: (p: Plan) => void; onStartTrial: () => void;
}) {
  ...
  return (
    <div className="screen-enter">
      ...
      <button className="btn btn-primary btn-lg btn-block" onClick={onStartTrial}
