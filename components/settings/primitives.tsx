...
export function Row({
  ...
  return (
    <div
      ...
      onMouseEnter={(e) => {
        if (onClick) (e.currentTarget as HTMLElement).style.opacity = ".7";
      }}
      onMouseLeave={(e) => {
        if (onClick) (e.currentTarget as HTMLElement).style.opacity = "1";
      }}
    >
...
export function Group({
  ...
  return (
    <div
      className="card"
      style={{ padding: "1.2rem 1.5rem", marginBottom: "1.1rem" }}
    >
