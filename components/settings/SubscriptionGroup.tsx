...
// ── Subscription ──
export function SubscriptionGroup({ sub, loadingPortal, onManage }: {
  sub: { status: string; currentPeriodEnd?: string | null; cancelAtPeriodEnd?: boolean; trialEnd?: string | null } | null;
