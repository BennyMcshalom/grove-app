    ...
    <div className="card" style={{ overflow: "hidden" }}>
      <div
        style={{
          ...
          background:
            "linear-gradient(160deg, var(--white) 55%, rgba(78,125,94,.05))",
        }}
      >
        <div
          style={{
        ...
        >
          ...
          <span
            ...
            style={{
              flexShrink: 0,
              background:
                left <= 1 ? "var(--ember-dim)" : "rgba(78,125,94,.12)",
              color: left <= 1 ? "var(--ember-deep)" : "var(--sage)",
              fontWeight: 600,
              fontSize: ".66rem",
            }}
          >
        ...
        <button
          ...
          style={{
            ...
            gap: ".45rem",
            fontSize: ".8rem",
            color: replies.length > 0 ? "var(--sage)" : "var(--ink-4)",
            fontWeight: 500,
          }}
        >
          <Icon
