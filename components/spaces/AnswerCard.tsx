...
import { useLikeAnswer, useAnswerComments, useAddAnswerComment } from '@/hooks/useAnonAsks';
...
export function AnswerCard({ answer, index }: { answer: AnonAskAnswer; index: number }) {
