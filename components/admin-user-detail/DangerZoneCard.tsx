...
// ── Danger zone ──
export function DangerZoneCard({ delConfirm, setDelConfirm, onDelete, deleting }: {
  delConfirm: string; setDelConfirm: (v: string) => void;
  ...
  return (
    <div className="card" style={{ padding: '1.2rem 1.5rem', marginBottom: '1.1rem', border: '1px solid var(--red-bdr)' }}>
      ...
      <div style={{ display: 'flex', gap: '.5rem' }}>
        ...
        <button onClick={onDelete} disabled={delConfirm !== 'DELETE' || deleting}
