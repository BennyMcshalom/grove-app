...
export function BondReveal({
  ...
  if (!bonds.length) {
    return (
      <div
        className="card"
        style={{ padding: "1.5rem 1.6rem", textAlign: "center" }}
      >
        <p
          style={{ color: "var(--ink-3)", fontSize: ".9rem", lineHeight: 1.6 }}
        >
                ...
                style={{
                  ...
                  background:
                    selectedBondId === b.id
                      ...
                      : "var(--surf-high)",
                  color:
                    selectedBondId === b.id ? "var(--ember)" : "var(--ink-2)",
                  border:
                    selectedBondId === b.id
                      ? "1.5px solid var(--ember-bdr)"
