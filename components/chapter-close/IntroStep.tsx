...
// ── Step 0: Intro ──
export function IntroStep({ spaceId, ready, onBegin }: { spaceId: string; ready: boolean; onBegin: () => void }) {
  return (
    <>
      ...
      {ready
        ? <button className="btn btn-primary btn-lg btn-pill fade-in" onClick={onBegin}>Begin</button>
