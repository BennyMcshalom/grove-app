...
export function ExtrasStep({ spaceId, spaceName, extras, onAddExtra, onUpdateExtra, onRemoveExtra, onContinue, onSkip }: {
  spaceId: string; spaceName: string; extras: string[];
  onAddExtra: () => void; onUpdateExtra: (i: number, v: string) => void; onRemoveExtra: (i: number) => void;
  ...
  return (
    <>
      ...
      <NavRow onSkip={onSkip} onContinue={onContinue} continueLabel="Close this chapter"/>
    </>
  );
}
