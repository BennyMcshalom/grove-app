...
export function SignupForm({ name, setName, email, setEmail, password, setPassword,
  agree, setAgree, loading, onSubmit }: {
  ...
  return (
    <>
      ...
      <button className="btn btn-primary btn-block" disabled={!agree || loading} onClick={onSubmit}
