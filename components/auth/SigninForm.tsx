...
export function SigninForm({ loginEmail, setLoginEmail, loginPassword, setLoginPassword, loading, onSubmit }: {
  ...
  return (
    <>
      ...
      <button className="btn btn-primary btn-block" disabled={loading} onClick={onSubmit}
