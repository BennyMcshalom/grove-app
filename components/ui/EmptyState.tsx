  ...
  feed: {
    ...
    illustration: (
      <svg width="88" height="88" viewBox="0 0 88 88" fill="none">
        ...
        />
        <path
          d="M44 55c0-6 4.5-10 9-10 0 6-4.5 10-9 10Z"
          fill="var(--sage)"
          opacity=".7"
        />
  ...
  groups: {
    ...
    illustration: (
      <svg width="88" height="88" viewBox="0 0 88 88" fill="none">
        ...
        />
        <path
          d="M33 58c0-6.1 4.9-11 11-11s11 4.9 11 11"
          stroke="var(--border-2)"
          strokeWidth="1.5"
          strokeLinecap="round"
          fill="none"
  ...
  notifications: {
    ...
    illustration: (
      <svg width="88" height="88" viewBox="0 0 88 88" fill="none">
        ...
        {/* Bell outline */}
        <path
          d="M44 26a12 12 0 0 1 12 12c0 10-3 14-3 14H35s-3-4-3-14a12 12 0 0 1 12-12Z"
          stroke="var(--ink-4)"
          strokeWidth="2"
          fill="var(--surf-high)"
        />
        <path
          d="M41 52a3 3 0 0 0 6 0"
          stroke="var(--ink-4)"
          strokeWidth="2"
          strokeLinecap="round"
          fill="none"
    ...
    illustration: (
      <svg width="88" height="88" viewBox="0 0 88 88" fill="none">
        ...
        {[0, 45, 90, 135, 180, 225, 270, 315].map((deg, i) => {
          ...
          const x1 = 44 + 17 * Math.cos(rad),
            y1 = 44 + 17 * Math.sin(rad);
          const x2 = 44 + 22 * Math.cos(rad),
            y2 = 44 + 22 * Math.sin(rad);
          return (
            <line
              key={i}
              x1={x1}
  ...
  ask: {
    ...
    illustration: (
      <svg width="88" height="88" viewBox="0 0 88 88" fill="none">
        ...
        {/* Speech bubble with ? */}
        <path
          d="M28 30h32a4 4 0 0 1 4 4v18a4 4 0 0 1-4 4H50l-6 6-6-6H28a4 4 0 0 1-4-4V34a4 4 0 0 1 4-4Z"
          fill="var(--surf-high)"
          stroke="var(--border-2)"
          strokeWidth="1.5"
        />
