          ...
          style={
            {
              ...
              height: size + 2,
              transform: "translate(-50%,-50%)",
              ["--aura-glow-dim" as string]: `${c}8C`,
              ["--aura-glow-strong" as string]: `${c}CC`,
              animation: "auraGlow 2.6s ease-in-out infinite",
        ...
        style={
          {
            ...
            height: size + 2,
            transform: "translate(-50%,-50%)",
            ["--aura-glow-dim" as string]: `${c}70`,
            ["--aura-glow-strong" as string]: `${c}A8`,
