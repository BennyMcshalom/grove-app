...
export default function DashboardLoading() {
  return (
    <div className="app-shell">
      {/* Sidebar skeleton — hidden on mobile, same as the real Sidebar */}
      <div className="app-sidebar">
        <aside style={{ width: 262, height: '100vh', flexShrink: 0, background: 'var(--white)',
      ...
      <main className="app-main" style={{ minWidth: 0, padding: '1.15rem 1.6rem' }}>
