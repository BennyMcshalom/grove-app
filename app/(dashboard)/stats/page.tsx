      ...
      >
        ...
        {isLoading ? (
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(160deg, var(--ember-dim), var(--green-dim))",
              maxWidth: 480,
              margin: "0 auto",
            }}
          >
          ...
          <>
            ...
            >
              <button
                onClick={() => setMi(Math.min(mi + 1, months.length - 1))}
                disabled={mi >= months.length - 1}
                style={{
                  flexShrink: 0,
                  opacity: mi >= months.length - 1 ? 0.3 : 1,
                }}
              >
            ...
            >
              {rows.map(([label, n]) => (
                <div key={label} style={{ textAlign: "center" }}>
                  ...
                  <div className="label-mono" style={{ marginTop: ".5rem" }}>
                    {label}
                  </div>
                </div>
              ))}
