            ...
            {DURATIONS.map((d) => (
              <button
                ...
                style={{
                  ...
                  color: dur === d ? "var(--ember-deep)" : "var(--ink-2)",
                }}
              >
                {d}
              </button>
          ...
          <button
            ...
            onClick={async () => {
              ...
              const durMap: Record<string, number> = {
                "Until this evening": 8,
                "Until tomorrow, 8am": 24,
                "For 3 days": 72,
                "For a week": 168,
              };
      ...
      <div style={{ textAlign: "center", maxWidth: 440 }} className="fade-in">
        <div
          style={{
            ...
            border: `1.5px solid rgba(240,234,224,.14)`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
          ...
          <div style={{ marginTop: "2.4rem" }}>
            <input
              ...
              style={{
                ...
                border: `1px solid rgba(240,234,224,.18)`,
                borderRadius: 100,
                padding: ".6rem 1.2rem",
                textAlign: "center",
                color: TEXT,
